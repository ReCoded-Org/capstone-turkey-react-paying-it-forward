        ...
        {!loading && (
          ...
          >
            ...
            <div className="ml-2 my-10 flex flex-col">
              ...
              <div className="flex justify-center mt-1">{data.owner.email}</div>
              <div className="flex justify-center my-8 mt-1">
                {data.owner.address}
              </div>
              <button
                className="flex items-center justify-between rounded-full bg-[#FF7338] mx-12 w-[200px] py-2 px-6 text-2sm text-white mt-6"
                type="button"
                onClick={() => {
              ...
              >
                ...
                <span className="font-bold text-4sm ml-2"> {t("makeRequest")} </span>
              </button>
            </div>
          </div>
        )}
