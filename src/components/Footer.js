  ...
  return (
    <footer className="bg-[#FF7338] text-left">
      <div className="container p-6 ml-[30px]">
        <div className="grid lg:grid-cols-6 md:grid-cols-2 p-4 ">
          <img className="w-[109px] h-[95px] m-[-30px]" src={Logo} alt="Logo" />
      ...
      <div className="relative flex py-2 items-center">
        <div className="flex-grow border-t border-[#FFFF] hidden md:block" />

        <span className="flex-shrink mx-4 border-[#FFFF] mt-[5px]">
